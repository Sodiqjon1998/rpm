...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            {{ Form::model($quiz, array('route' => array('teacher.quiz.update', $quiz->id), 'method' => 'PUT')) }}
            <div class="row">
                <div class="col-md-10">
                    <div class="mb-3">
                        {{ Form::label('name', 'Viktorina', ['class'=>'form-label']) }}
                        <input type="text" name="name" id="name" value="{{$quiz->name}}" class="form-control">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="">
