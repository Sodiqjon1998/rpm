...
@section('content')
            ...
            <div class="card">
                <h4 class="card-header bg-opacity-1">
                    <a href="{{ route('teacher.questionItems.create') }}" class="btn btn-success btn-sm"
                        data-bs-toggle="modal" data-bs-target="#addQuestionItemsModal">
                        <i class="fa fa-plus-circle"></i>
                    </a>
                    <a href="{{ route('teacher.questionItems.create') }}" class="btn btn-outline-info btn-sm float-end"
                        data-bs-toggle="modal" data-bs-target="#importQuestionItemsModal">
    ...
    <!--EDIT Modal -->
    <div class="modal fade" id="editQuestionItemsModal" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-body editModalBody">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="editQuestion" placeholder="Enter question" required
                                    id="" class="w-100 form-control-sm question">
                                {{-- <textarea cols="5" id="editor2" name="editQuestion" class="question" rows="3" data-sample-short
                                    required>
                    ...
                    if (questionItems[i]['id'] == qid) {
                        ...
                        for (let j = 0; j < answerLength; j++) {
                            ...
                            if (questionItems[i]['answers'][j]['is_correct'] == 1) {
                                ...
                                is_correct =
                                    "<i class='fa fa-check-circle btn btn-outline-success btn-xs'></i>";
                            }
                    ...
                    success: function(data) {
                        ...
                        for (let i = 0; i < editAnswersLength; i++) {
                            ...
                            html += `
                                ...
                                checked + `>
                                    <div class="pt-2">
                                        <input type="text" name="answers[]" value="` + data.data.questionItems[
                                    'answers'][i]['answer'] + `" placeholder="Enter answer" required id="" style="width: 370px">
                                    </div>
                                    <button class="btn btn-danger btn-sm mt-2 removeButton deleteButton" data-id="` +
                                data.data.questionItems['answers'][i]['id'] + `"><i class="fa fa-trash"></i></button>
                                </div>
                            `;
                        }
