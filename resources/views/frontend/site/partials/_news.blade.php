    ...
    <div class="container">
        ...
        <div class="recent-news-carousel owl-carousel owl-btn-1 col-12 p-lr0">
            <div class="item">
                <div class="recent-news">
                    <div class="action-box">
                        <img src="{{asset('f/assets/images/blog/latest-blog/pic1.jpg')}}" alt="">
                    </div>
                    <div class="info-bx">
                        <ul class="media-post">
            ...
            <div class="item">
                <div class="recent-news">
                    <div class="action-box">
                        <img src="{{asset('f/assets/images/blog/latest-blog/pic2.jpg')}}" alt="">
                    </div>
                    <div class="info-bx">
                        <ul class="media-post">
            ...
            <div class="item">
                <div class="recent-news">
                    <div class="action-box">
                        <img src="{{asset('f/assets/images/blog/latest-blog/pic3.jpg')}}" alt="">
                    </div>
                    <div class="info-bx">
                        <ul class="media-post">
