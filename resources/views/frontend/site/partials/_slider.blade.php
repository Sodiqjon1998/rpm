        ...
        <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
            <ul> <!-- SLIDE  -->
                @foreach ($sliders as $key => $slider)
                    <li data-index="rs-{{$key+1}}00" data-transition="parallaxvertical" data-slotamount="default"
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset($slider->img) }}" alt="" data-bgposition="center center"
                            data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg"
                            data-no-retina />

                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption tp-shape tp-shapewrapper " id="slide-{{ $key + 1 }}00-layer-{{$key + 1}}"
