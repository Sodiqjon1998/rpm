                ...
                <div class="topbar-right">
                    <ul>
                        ...
                        @if (Auth::check())
                            ...
                            <li>
                                <a class="dropdown-item text-danger" href="{{ route('frontend.destroy') }}"
                                    onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">
                                    <i class="fa fa-sign-out align-middle me-1 text-danger"></i>
                                    <span class="align-middle">Chiqish</span>
                                </a>
                                <form id="frm-logout" action="{{ route('frontend.destroy') }}" method="POST"
                                    style="display: none;">
                                    {{ csrf_field() }}
                                </form>
                            </li>
